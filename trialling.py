...
print("Please enter the lengths for your shape (or radius if it's a circle), pressing 'enter' after each one. Print the number 'xxx' once you have entered all of them")
